  ...
  render() {
   ...
   const icon={
    ...
    return (
      ...
      >
        <Map onReady={(mapProps, map) => this._mapLoaded(mapProps, map)} google={this.props.google} zoom={this.props.map_zoom}  defaultZoom={1} initialCenter={{lat: 19,lng: 10}} center={this.props.map_centre} zoomControl={false} mapTypeControl={false} scaleControl={false} fullscreenControl={false} scrollwheel={false} disableDoubleClickZoom={true} >
