          ...
          <div className="container">
                <div className="row py-4">
                    <div className="col-md-5 my-1">
                            <div className="footer-widget footer-info">
                                <h4 className="widget-title pb-3">打開您自己的KDO中心</h4>
                                <p>您有興趣經營自己的學前班嗎？請訪問我們的特許經營網站，以了解如何開設自己的Kïdo學校。</p>
                            </div>
                        </div>
                    <div className="col-md-2 my-1">
                            <div className="footer-widget footer-info">
                                ...
                                <ul className="list-unstyled">
                                  ...
                                  <li><Link to="/ourcentres?srch-trm=greater-london">大倫敦</Link></li>
                                  <li><Link to="/ourcentres?srch-trm=houston">休斯敦</Link></li>
                                  <li><Link to="/ourcentres?srch-trm=austin">奧斯丁</Link></li>
                        ...
                        <div className="col-md-2 my-1">
                            <div className="footer-widget footer-info">
                            <h4 className="widget-title pb-3">關於基多</h4>
                                <ul className="list-unstyled">
                                  ...
                                  <li><a href="https://www.kidofranchise.com/" target="_blank" rel="noreferrer">專營權</a></li>
                                  <li><Link to="/privacy-policy">隱私政策</Link></li>
                        ...
                        <div className="col-md-2 my-1">
                            <div className="footer-widget footer-info">
                                <h4 className="widget-title pb-3">接觸</h4>
                                <ul className="list-unstyled">
                ...
                <div className="container py-3">
                  <div className="d-flex justify-content-between">
                    <div className="terms"><Link to="/">條款和條件</Link></div>
                    <div className="all-rights"><Link to="/">&copy;2021 Kïdo | 版權所有</Link></div>
                  </div>
                </div>
        </section>
